...
contract WalkingBetweenWorlds is ERC721, ContextMixin, ERC721Enumerable, ReentrancyGuard, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    Phases _currentPhase = Phases.VIP;
    ...
    string public constant TEMP_META_BASE = "https://www.walkingbetweenworlds.net/mint/metadata/";
    ...
    constructor() ERC721( "Walking Between Worlds", "WalkingBetweenWorlds" ) {}
    ...
    function vipMint( uint256 numberOfTokens ) nonReentrant external payable {
    ...
    function presaleMint( uint256 numberOfTokens ) nonReentrant external payable {
        require( !mintingPaused, "Minting is paused" );
        require( msg.sender == tx.origin, "Transactions from smart contracts not allowed" );
    ...
    function freeMint( address to, uint256 numberOfTokens ) nonReentrant external onlyOwner {
        require( msg.sender == tx.origin, "Transactions from smart contracts not allowed" );
